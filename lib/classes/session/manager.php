...
class manager {
    ...
    protected static function prepare_cookies() {
        ...
        session_set_cookie_params($sessionoptions['lifetime'], $sessionoptions['path'], $sessionoptions['domain'], $sessionoptions['secure'], $sessionoptions['httponly']);
        //$set = session_set_cookie_params($sessionoptions);
